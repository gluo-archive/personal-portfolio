    ...
    this.items = [
      {
        'label': 'Berkeleytime',
        'description':
            'I have been working on Berkeleytime\'s frontend for the past two years. ' +
      ...
      },
      {
        ...
        'description':
            'I trained generative and discriminative models from scratch (ie only using Numpy) ' +
        ...
        'tags': [
          'Gaussian Discriminant Analysis', 'Regression', 'Decision Trees',
      ...
      },
      {
        ...
        'description':
            'I created an approximation algorithm for the NP-hard problem ' +
