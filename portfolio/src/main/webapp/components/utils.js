...
export function shuffle(arr) {
  return arr.map((item) => ({key: Math.random(), value: item}))
...
// Fetch JSON from api call; use async and await since it returns a Promise
// until resolved
export function fetchJSON(url) {
  const proxyURL =
      'https://cors-anywhere.herokuapp.com/';  // Bypass
